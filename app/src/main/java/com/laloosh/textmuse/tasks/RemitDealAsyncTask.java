...
public class RemitDealAsyncTask extends AsyncTask<Void, Void, String> {
    ...
    public RemitDealAsyncTask(DefaultResultHandler handler, int appId, int messageId, Context context) {
    ...
    protected String doInBackground(Void... params) {
        ...
        Log.d(Constants.TAG, "Starting async task to remit deal");
        ...
        Log.d(Constants.TAG, "Finished async task to remit a deal, length = " + (result == null ? "null" : Integer.toString(result.length())));
